...
Image<float3> render_img("render/sponza/1/render.png");
Image<float3> albedo_img("render/sponza/1/albedo.png");
Image<float3> normal_img("render/sponza/1/normal.png");
